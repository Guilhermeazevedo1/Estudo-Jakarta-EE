...
import br.com.guilherme.model.Aula;
import br.com.guilherme.model.Aula_;
import br.com.guilherme.model.Curso;
import br.com.guilherme.model.Curso_;
import br.com.guilherme.model.Modulo;
import br.com.guilherme.model.Modulo_;
...
public class QueryBean {
	...
	public List<Integer> executar4(){
		...
		q.where(cb.and(cb.equal(curso.get(Curso_.id), 1), cb.greaterThanOrEqualTo(aula.get(Aula_.duracao), 10)));
